...
<nav class="navbar">
    ...
    <ul class="nav-links">
        ...
        <li class="icon_list">
            <a class="icon" href="/templates/MyAccount/my_account.html">
        ...
        <li class="icon_list">
            <a class="icon" href="/templates/Favorites/my_favorites.html">
        ...
        <li class="icon_list">
            <a class="icon" href="/templates/My_Ads/my_ads.html">
        ...
        <li class="icon_list">
            <a class="icon" href="/templates/My_Messages/my_messages.html">
        ...
        <li class="icon_list">
            <a class="icon" href="/templates/RegistrationWindow/login_window.html">Log</a>
        </li>
    </ul>
</nav>
</#macro>
